...
Each wiring starts at its best single gain; a coordinate search then moves one region's factor at a
time (x2, then x1.41) while memory with readout noise improves and the reservoir stays valid. Reported
numbers come from a fresh white-noise input the search never saw.
